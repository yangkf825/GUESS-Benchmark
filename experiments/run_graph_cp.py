...
parser.add_argument('--save_dir',      type=str, default='./results/graph_cp')
...
def run_elliptic():
    ...
    _save(cp_rows, uq_runs, split_names, all_keys,
          os.path.join(args.save_dir, f'elliptic_graphcp_{args.score}_{args.mode}_a{args.alpha}'))
...
def run_arxiv():
    ...
    _save(cp_rows, uq_runs, split_names, all_keys,
          os.path.join(args.save_dir, f'arxiv_graphcp_{args.score}_{args.mode}_a{args.alpha}'))
...
def run_eerm():
    ...
    _save(cp_rows, uq_runs, split_names, all_keys,
          os.path.join(args.save_dir, f'{ds}_graphcp_{args.score}_{args.mode}_a{args.alpha}'))
