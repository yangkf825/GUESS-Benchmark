...
parser.add_argument('--save_dir',      type=str,   default='./save_model_gats')
...
def get_base_model(nfeat, nclass):
    if args.model == 'GCN':
        return BaseGCN(nfeat, args.hidden, nclass, args.dropout)
    return BaseGAT(nfeat, args.hidden, nclass, args.dropout)
